...
var deleteButtons = document.querySelectorAll('.delete'); // finds the delete button in the page javascript
...
deleteButtons.forEach(function(button){
  ...
  button.addEventListener('click', function(ev){
    ...
    if (!okToDelete) {
      ev.preventDefault();  // if it is not sure it will  Prevent the click event propagating
    }
